...
public class Controlador {
	...
	ArrayList <Estudiante> e  = miDAO.buscar (correo);
	System.out.println ("Información del estudiante ");
        ...
        if (e==null) {
           System.out.println ("El estudiante no se encuentra registrado en el instituto");
            ...
            Estudiante eBuscar = e.get (i);
            miVista.mostrarEstudiante (eBuscar);
	...
	String correoInstitucionalN = miVista.leerCorreoInstitucional ();
        ...
        ArrayList <Estudiante> listaEstudiantes = miDAO.buscar(correoInstitucionalN);               
        ...
        if (listaEstudiantes==null){
            ...
            String nombres           = "Nombre inicial";
            String apellidos         = "Apellido inicial";
            String fechaNacimiento   = "FechaNacimiento inicial";
