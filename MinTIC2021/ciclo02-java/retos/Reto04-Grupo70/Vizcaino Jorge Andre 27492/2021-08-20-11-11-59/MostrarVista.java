...
public class MostrarVista {
    ...
    public void mostrarMenu2 () {
        System.out.println ("\nSección Consulta");
        System.out.println ("1. Por correo institucional:");
        System.out.println ("2. Por apellidos de estudiantes:");
        System.out.println ("3. Por programa:");
        System.out.println ("4. Por cantidad de estudiantes en un mismo programa:");
        System.out.println ("5. Por fecha de nacimiento:");
        System.out.println ("6. Por número celular:");
    ...
    public void leerDatosNuevo (Estudiante nuevo) {
        ...
        nuevo.correo              = leerCorreo();
        nuevo.nroCelular          = leerNumeroCelular ();
        nuevo.nroFijo             = leerNumeroFijo ();
    ...
    public void mostrarNyA (Estudiante e) {
    	
        System.out.println ("Nombres: " + e.nombres);
        System.out.println ("Apellidos: " + e.apellidos); 
    }
    
    public void mostrarNyP (Estudiante e) {
