...
while (Temperatura_Max != 0 and Temperatura_Min != 0):
    ...
    if (Temperatura_Max < 5 or Temperatura_Max > 35) and  (Temperatura_Min< 5 or Temperatura_Min > 35): #Sí ninguna temperatura del día se encuentra dentro del rango.

        Contador_Ambos = Contador_Ambos + 1 #Sumatoria de las temperaturas minimas fuera del rango.

    else:

        # Errores con Temp maximas    

        if (35 < Temperatura_Max): #Evalúa Errores altas o máximas mayores a 35.
        ...
        # Errores con Temp minimas

        if  (Temperatura_Min < 5): #Evalúa Errores altas o máximas mayores a 35.

            Contador_Min = Contador_Min + 1 #Acumula el número de temperaturas máximas dentro del rango.

            Acumulador_Min = Acumulador_Min + Temperatura_Min #Sumatoria de las temperaturas maximas dentro del rango.
