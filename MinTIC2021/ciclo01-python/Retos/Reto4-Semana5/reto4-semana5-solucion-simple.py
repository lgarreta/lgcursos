...
if (horasTrabajadas > 40):
    ...
    valorHorasExtra = 1.8*valorHoraNormal
    horasNormal = 40
else:
    horasNormal  = horasTrabajadas
#

pagoHorasNormal = horasNormal*valorHoraNormal
pagoHorasExtra  = horasExtra*valorHorasExtra 

sueldoBruto = pagoHorasNormal + pagoHorasExtra 
